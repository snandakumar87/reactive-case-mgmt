...
public class AccountValidationBean {
	...
	public String validateTxn(String body) {
		...
		try {
			...
			LinkedHashMap<String,Object> val = (LinkedHashMap<String,Object>)mapVal.get("case-data");
			...
			transaction.setTxnTs(new Date((int)val.get("txnTs")));
			...
			for (Object evnt : events) {
				...
				triggerAdhocTask(caseId,resultJson);
			}
